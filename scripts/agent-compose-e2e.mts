/**
 * End-to-end smoke test for MULTI-SERVICE COMPOSE STACK deploys via the agent (the
 * remote-server compose path).
 */
...
async function main() {
  ...
  // bind-mounts a template config file the control plane carries as a mount. Both
  // must come up labelled with deplo.slug for the stack to be discoverable.
