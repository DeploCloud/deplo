 ...
 * assembles its OWN rows never passes through `node-access.ts`, so it has to ask.
 * A loop over the reads, because the failure is "somebody adds a list and forgets".
 */
