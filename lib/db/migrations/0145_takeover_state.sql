...
ALTER TABLE "instance_settings" ADD COLUMN IF NOT EXISTS "takeover_platform" text;
ALTER TABLE "instance_settings" ADD COLUMN IF NOT EXISTS "takeover_state" text;
ALTER TABLE "instance_settings" ADD COLUMN IF NOT EXISTS "takeover_run_id" text;
ALTER TABLE "instance_settings" ADD COLUMN IF NOT EXISTS "takeover_seen_external_at" timestamp with time zone;
...
ALTER TABLE "migration_run_targets" ADD COLUMN IF NOT EXISTS "stopped_kind" text;
