...
// Registration is TWO round trips because WebAuthn is: the browser needs a challenge
// first, and the authenticator's answer means nothing without the challenge it replies to.
