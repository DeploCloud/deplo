...
/**
 * A `set -u` violation is a shell error, not a failed command: the ERR trap never
 * sees it, and for four days a fresh install died on a bare
 * "line 1329: DEPLO_DOMAIN: unbound variable" with no transcript and no next step.
 */
