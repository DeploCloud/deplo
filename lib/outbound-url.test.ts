...
test("embedded-IPv4 forms of an internal address are refused", async () => {
  ...
  await refused("https://[64:ff9b::7f00:1]/");
  await refused("https://[64:ff9b:1::a9fe:a9fe]/");
  await refused("https://[2002:7f00:1::1]/");
  await refused("https://[2002:c0a8:101::]/");
  await refused("https://[2001:0:0:0:0:0:80ff:fffe]/");
...
test("public addresses in every spelling stay allowed", async () => {
  ...
  await allowed("https://[2002:808:808::1]/");
