...
/*
 * Nothing typed arrives from a source panel: neither Dokploy nor Coolify marks a
 * variable secret, so every migrated variable lands `plain` and stays readable.
 */
