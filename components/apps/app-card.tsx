...
export function AppCard({
  ...
  const confirm = (
    <DeleteWithArtifacts
      ...
      title="Delete app?"
      description={`Deleting ${project.name} permanently removes its data, deployments, domains, environment variables and every backup it has stored. This action cannot be undone.`}
