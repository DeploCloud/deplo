...
/**
 * Project Settings → HTTP Basic Auth. Create username/password credentials that
    ...
    startTransition(async () => {
      const res = editing
        ...
        : await gqlAction<{ addBasicAuthUser: { id: string } }>(
            `mutation($projectId: String!, $username: String!, $password: String!) {
              addBasicAuthUser(projectId: $projectId, username: $username, password: $password) { id }
            }`,
