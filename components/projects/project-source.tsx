 ...
 *  both `Project` and `ProjectSummary`. */
export type ProjectSourceLike = {
  source: string;
  compose: string | null;
  repo: GitRepo | null;
 ...
 * template projects), then a real git repo, then docker-image / upload, then a
 * generic container fallback.
 */
export function describeProjectSource(
  project: ProjectSourceLike,
