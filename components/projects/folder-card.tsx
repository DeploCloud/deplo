...
export function FolderCard({
  ...
  const count = folder.projectCount;
  const subCount = folder.subfolderCount ?? 0;
  // "3 projects · 2 folders" — the subfolder part only shows when nested.
  const countLabel =
  ...
  const dialogs = canManageThisFolder || canShare ? (
    <>
      ...
      <ConfirmAction
        ...
        description="The folder is removed, but its projects are kept — they move back to the top level. This cannot be undone."
